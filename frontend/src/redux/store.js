...
import { productListReducer, productDetailsReducer, productcCreateReviewReducer } from './reducer/ProductReducer.js';
...
const reducer = combineReducers({
    ...
    productReviewCreate: productcCreateReviewReducer,
    cart: cartReducer,
