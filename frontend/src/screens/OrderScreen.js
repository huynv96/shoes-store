...
const OrderScreen = ({ match }) => {
    ...
    if (!loading) {
        ...
        order.totalPrice = addDecimals(
            (Number(order.itemsPrice) + Number(order.taxPrice) + Number(order.shippingPrice)).toFixed(2),
        );
    }
    useEffect(() => {
                            ...
                            <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
                                <div className="row">
                                    ...
                                    <div className="col-md-8 center">
                                        ...
                                        <p>
                                            Address: {order.shippingAddress.city}, {order.shippingAddress.address}, POX:{' '}
